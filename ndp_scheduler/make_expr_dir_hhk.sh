#!/bin/bash
#python3 make_expr_dir_hhk.py --model ../../NDP_ISCA/traces/BERT_large_3_b8 --packet-size 32 --gpu 2 --buffer 2 --simd 8 --passes fw &
#python3 make_expr_dir_hhk.py --model ../../NDP_ISCA/traces/BERT_large_3_b8 --packet-size 32 --gpu 2 --buffer 2 --simd 8 --passes bw &
#python3 make_expr_dir_hhk.py --model ../../NDP_ISCA/traces/BERT_large_3_b8 --packet-size 32 --gpu 1 --buffer 1 --simd 8 --passes fw &
#python3 make_expr_dir_hhk.py --model ../../NDP_ISCA/traces/BERT_large_3_b8 --packet-size 32 --gpu 1 --buffer 1 --simd 8 --passes bw &
